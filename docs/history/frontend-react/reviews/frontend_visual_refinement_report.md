...
回滚点：`a7d82fb3cde65e67401576388c13534605eb58a1`。重构前截图位于本目录下的 `workspace_v2_baseline/`。原浏览器基线在完成首页浅色、首页深色和学生空态后，真实任务超过旧脚本 90 秒等待上限；该失败作为基线问题保留。Preflight 当时为 19/19。
...
重构后 17 张截图位于本目录下的 `workspace_v2_screenshots/`，覆盖空态、CT/AE/DE、证据联动、过程、回答信息、专业求解文字/图片、Mock/fallback、统一调试、证据对照、演示中心、1280×720、深色和 390px 移动端。
