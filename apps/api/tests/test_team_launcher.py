...
def test_frontend_build_check_matches_served_legacy_workspace(monkeypatch) -> None:
    launcher = load_launcher()
    ...
    class Response:
        ...
        def read(self) -> bytes:
            return (
                b'<body class="workspace-page">'
                b'<form id="student-form"></form>'
                b'<script src="/debug-assets/workspace.js"></script>'
            )
