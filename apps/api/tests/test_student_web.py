...
def test_student_page_uses_unified_task_and_event_apis(client) -> None:
    ...
    assert "20260812-workspace-evidence-clean-v3" in page.text
    assert "workspace.js?v=20260812-workspace-evidence-clean-v3" in page.text
    assert "ui-core.js?v=20260812-workspace-evidence-clean-v3" in page.text
