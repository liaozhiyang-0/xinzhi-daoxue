export const DEMO_SCENARIOS = [
    {
        ...
        course: "模拟电子技术",
        tags: ["任务规划", "课程资料", "教学设计"],
        exampleInput: "请为反馈放大器设计一节90分钟课堂：给出教学目标、课堂流程、例题、分层练习和形成性评价，并标出需要教师确认的课程版本或基础假设。",
        intent: "lesson_prep",
        courseId: "AE",
        caseId: "TP-01",
    },
    {
        ...
        course: "电路理论",
        tags: ["首错定位", "验证", "分层反馈"],
        exampleInput: "请检查下面这道电路题的分步解答，定位最早出现的实质错误，说明它如何影响后续步骤，并给出一个不直接替学生做完的验证任务。",
    ...
    },
    {
        ...
        course: "信号与系统",
        tags: ["学习状态", "前置关系", "阶段计划"],
        exampleInput: "根据我的历史表现制定下一阶段学习路径：卷积3/5、傅里叶级数4/5、傅里叶变换2/5、采样1/4、拉普拉斯4/4。请说明优先级、前置知识和每阶段的验证任务。",
    ...
    },
    {
        ...
        course: "科研检索",
        tags: ["范围约束", "证据治理", "引用核验"],
        exampleInput: "请检索2025年1月至2026年8月医学影像基础模型用于肺结节分割的研究，整理研究问题、方法、证据来源和局限；没有可靠来源支持的定量结论不要补写。",
    ...
    },
    {
        ...
        course: "课程资产治理",
        tags: ["版本治理", "权限审查", "发布审核"],
        exampleInput: "请审查一份课程资料更新：2026版拟替代2025版，但部分来源不明，且资料包含教师备注。请给出版本关系、风险、发布前检查和是否允许面向学生发布的结论。",
    ...
    },
    {
        ...
        course: "模拟电子技术",
        tags: ["图像理解", "电路求解", "边界验证"],
        exampleInput: "请结合随附运算放大器电路图逐步分析：先判断是否处于线性负反馈状态，再说明虚短和虚断能否使用，推导关键节点关系，并指出输出饱和边界、图像读数不确定处和需要人工复核的假设。",
...
export async function loadScenarioImage(scenario) {
