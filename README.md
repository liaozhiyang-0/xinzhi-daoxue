...
早期 Spring Boot、MySQL、Vue3 和 MaaS 微调设想是历史方案，不是当前可运行技术栈。相关留档仍保存在 `backend/`、`frontend/`、`database/`、`deploy/`、`platform_stack/` 和 `docs/01_project_positioning.md` 至 `docs/07_yuque_index.md`，本轮未删除。
